...
export class MovieService {
  ...
  makeDownloadRequest(query: string, name: string, year: string, quality: string, Imdb: number) {
    var queryApiHeaders = {
    ...
    return this.http.post<QueryRequest>(movieUrl, { "query": query, 'name': name, 'year': year, 'quality': quality, 'Imdb': Imdb }, { headers: queryApiHeaders });
  }
