...
@Component({
  ...
  `,
  styleUrls: ['./upcoming-gallery-movies.component.sass']
})
export class UpcomingGalleryMoviesComponent {
  ...
  ngOnInit() {
    ...
    this.movieService.getUpcoming(page).subscribe((resp) => {
      resp['results'].forEach((movie) => {
        ...
        let result: MovieResult[] = [{ adult: isAdult, backdrop_path: backdropPath, genre_ids: genreIds, id: id, title: title, release_date: releaseDate, original_language: originalLanguage, original_title: originalTitle, overview: overview, popularity: popularity, poster_path: posterPath, vote_average: voteAverage, vote_count: voteCount, video: video, in_plex: false }]
    ...
    this.movieService.getUpcoming(page).subscribe((resp) => {
      resp['results'].forEach((movie) => {
        ...
        let result: MovieResult[] = [{ adult: isAdult, backdrop_path: backdropPath, genre_ids: genreIds, id: id, title: title, release_date: releaseDate, original_language: originalLanguage, original_title: originalTitle, overview: overview, popularity: popularity, poster_path: posterPath, vote_average: voteAverage, vote_count: voteCount, video: video, in_plex }]
