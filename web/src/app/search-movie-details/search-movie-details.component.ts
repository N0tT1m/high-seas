...
import { FormControl, FormGroup, ReactiveFormsModule, NgModel, FormsModule } from '@angular/forms';
...
export class SearchMovieDetailsComponent {
  ...
  ngOnInit() {
    ...
    this.movieService.getAllMovies(page, query).subscribe((resp) => {
