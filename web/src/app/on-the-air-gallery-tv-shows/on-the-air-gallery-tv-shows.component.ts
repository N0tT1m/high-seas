  ...
  <div class="container">
    ...
    <div class="show-names-wrapper">
      <h3 class="name" *ngFor="let show of showNames">
        <a [routerLink]="['/on-the-air/shows/details', show['id'], show['page']]">{{ show['name'] }}</a>
      </h3>
    </div>
  </div>
  `,
  styleUrls: ['./on-the-air-gallery-tv-shows.component.sass']
})
export class OnTheAirGalleryTvShowsComponent {
  ...
  constructor(private gallery: Gallery) {
    this.tvShowService.getInitialOnTheAirPage().subscribe((resp) => {
