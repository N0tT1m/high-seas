...
import { NowPlayingMoviesListComponent } from '../now-playing-movies-list/now-playing-movies-list.component';
...
@Component({
  ...
  standalone: true,
  imports: [GalleryModule, CommonModule, RouterModule, NowPlayingMoviesListComponent, FormsModule, MatPaginatorModule],
