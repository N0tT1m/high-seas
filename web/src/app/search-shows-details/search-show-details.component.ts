  ...
  template: `
    <section class="header-section earth-spirit">
      <section class="header-section earth-spirit" *ngFor="let show of this.fetchedShow?.results; index as i;">
        ...
        <section class="earth-spirit show-description">
        ...
        <section class="show earth-spirit">
          ...
          <button class="download-button" (click)="downloadShow(show.name, show.original_language)">Download Show</button>
        </section>
      </section>
    </section>
    `,
  styleUrls: ['./search-show-details.component.sass', '../../styles.sass'],
})

export class SearchTvShowDetailsComponent {
  ...
  downloadShow(title: string, lang: string) {
    if (lang === 'ja') {
      console.log('ANIME');
