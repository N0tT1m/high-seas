...
@Component({
  ...
  `,
  styleUrls: ['./top-rated-gallery-tv-shows.component.sass']
})
export class TopRatedGalleryTvShowsComponent {
  ...
  constructor(private gallery: Gallery) {
    this.tvShowService.getInitialTopRatedPage().subscribe((resp) => {
