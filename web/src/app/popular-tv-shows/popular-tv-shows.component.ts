...
import { PopularTvShowsListComponent } from '../popular-tv-shows-list/popular-tv-shows-list.component';

@Component({
  selector: 'app-popular-tv-shows',
  standalone: true,
  imports: [GalleryModule, CommonModule, RouterModule, PopularTvShowsListComponent, FormsModule, MatPaginatorModule],
