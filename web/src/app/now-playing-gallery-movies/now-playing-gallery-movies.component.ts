...
@Component({
  ...
  `,
  styleUrls: ['./now-playing-gallery-movies.component.sass']
})
export class NowPlayingGalleryMoviesComponent {
  ...
  constructor(private gallery: Gallery) {
    this.movieService.getInitialNowPlayingPage().subscribe((resp) => {
