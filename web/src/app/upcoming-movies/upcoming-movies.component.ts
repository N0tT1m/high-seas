...
@Component({
  ...
  template: `
    ...
    <h3 class="titles" *ngFor="let movie of movieTitles"><a [routerLink]="['/upcoming/movies/details', movie['id'], movie['page']]">{{ movie['title'] }}</a></h3>
  `,
  styleUrls: ['./upcoming-movies.component.sass']
})
