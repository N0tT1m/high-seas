...
@Component({
  ...
  standalone: true,
  imports: [GalleryModule, CommonModule, RouterModule, UpcomingMoviesListComponent, FormsModule, MatPaginatorModule],
  ...
  `,
  styleUrls: ['./upcoming-movies.component.sass', '../../styles.sass'],
})
